...
__all__ = ['get_board_by_id_from_path', 'get_board_by_id_from_query']

model = models.Board
crud_repo = crud.board #todo naming
id_param_description = 'The UUID id of the board'
